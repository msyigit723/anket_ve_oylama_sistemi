    ...
    <div className={styles.page}>
      <div className={`${styles.card} ${styles.cardAdmin}`}>
        <div className={styles.logoArea}>
          ...
          <h1 className={styles.logoTitle}>Yönetici Girişi</h1>
          <p className={styles.logoSub}>Bu alan sadece yetkili yöneticiler içindir</p>
          <div style={{ marginTop: 10, display: 'flex', justifyContent: 'center' }}>
            <span className={styles.adminBadge}>🔒 Güvenli Erişim Noktası</span>
          </div>
        </div>
        ...
        <form className={styles.form} onSubmit={handleSubmit} noValidate>
          <div className={styles.field}>
            <label className={styles.label}>Yönetici E-posta</label>
          ...
          <button type="submit" className={styles.submitBtn} disabled={loading}>
            {loading ? <><span className={styles.spinner} /> Doğrulanıyor…</> : '🛡️ Yönetici Girişi'}
          </button>
        </form>
      </div>
    </div>
